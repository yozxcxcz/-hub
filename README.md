...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('กาก Hub BF Premium') then
        makefolder('กาก Hub BF Premium')
    end
    if not _G.Dis and not isfile('กาก Hub BF Premium/'..Name..'.json') then
        writefile('กาก Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('กาก Hub BF Premium') and isfile('กาก Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('กาก Hub BF Premium/'..Name..'.json'))
